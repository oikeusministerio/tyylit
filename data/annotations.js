...
"comments" : [
	{
		...
		"title" : "Masthead",
		"comment": "The main header of the site doesn't take up too much screen real estate in order to keep the focus on the core content. It's using a linear CSS gradient instead of a background image to give greater design flexibility and reduce HTTP requests.</p>"
	},
	{
		"el": ".logo",
		"title" : "Logo",
	...
	},
	{
		"el": "#atoms-colors",
		"title" : "Värit – Colors",
		"comment": "Palvelut käyttävät samaa värisarjaa. Kullekin palvelulle on valittu oma heräteväri. Värejä suunniteltaessa on huomioitava <a href=\"http://www.w3.org/Translations/WCAG20-fi/\" target=\"_blank\">WCAG 2.0</a> kontrasti- luminanssi- ja fonttivaatimukset.</p><p>Huomiovärillä merkitään käyttäjätarinan mukaan seuraava painike jota käyttäjän odotetaan pääkäyttötapauksen mukaan painavan. Vaihtoehtoisten käyttötapausten painikkeet ovat tummanharmaat. Painikkeita joita ei pääse käyttämään, ei piiloteta vaan ne näytetään vaaleammalla harmaalla.</p>Services all use same colorspace. There is a primary attention color for each service, that also serves as the brand color in the logo. Colors have their luminance according to WCAG20 accessibility requirements.</p><h3>Yhteiset Värit – Common Colors</h3><h3>Valkoinen (#FFFFF)</h3><p>Tausta huomioalueille.</p><h3>Vaaleanharmaa (#F0F0F0)</h3><p>Toissijainen taustaväri vähemmälle huomiolle tarkoitetulle alueille.</p><h3>Tummanharmaa (#444444)</h3><p>Tummanharmaa eli murrettu musta.</p><h3>Sininen (#0089F2)</h3><p>Sininen linkkiväri kautta palveluiden, joka tarjoaa paremman kontrastin kuin korostusväri eikä ole sidottu yhteen palveluun.</p><h3>Punainen (#FF0000)</h3><p>Punaista käytetään virheilmoituksissa ja muissa kriittisissä käyttäjäpalautteissa, jonka tarkoitus on saada käyttäjä pysähtyä keskeyttämään tekemänsä.</p><h3>Vihreä (#2FC090)</h3><p>Palvelun sisäisissä ilmoituksissa ja infolohkoissa on ohjealueella käytössä vihreä (tai punainen) väri. Vihreää käytetään viestimään onnistuneesti päättyneestä käyttötapauksesta tai informaatiosta, jonka tarkoitus on palkita ja kannustaa käyttäjää jatkamaan käyttöä.</p><h3>Harmaa (#E3E3E3)</h3><p>Pois käytöstä olevan tekstin, ikonin tai painikkeen väri.</p><h3>Palvelukohtaiset ohjeet – Service-specific instructions</h3><h4>Otakantaa</h4><h3>Turkoosi (#17CEE4)</h3><p>Ensisijainen huomioväri. Käytetään ensisijaisesti aktiivisissa painikkeissa – esim. lomakkeiden lähetyksissä.</p><h3>Keltainen (#D4DC3F)</h3><p>Toissijainen huomioväri. Käytetään vaihtoehtoisia käyttötapauksia käynnistävissä painikkeissa – esim. hankkeen lisäasetuksissa.</p><h4>Lausuntopalvelu (#F16521)</h4><h3>Oranssi</h3><p>Lausuntopalvelun ensisijainen huomioväri ja palvelun logon väri.</p><h3>Oranssi 2 (#12C4AE)</h3><p>Lausuntopalvelun ensisijainen huomioväri ja palvelun logon väri.</p><h3>Turkoosi (?)</h3><p>Lausuntopalvelun toisisijainen huomioväri. Ei käytössä käyttöönottovaiheessa. Voi poimia sopivan Otakantaa osallistumistapojen väreistä.</p><h4>Kansalaisaloite (#077480)/h4><h3>Vihreä</h3><p>Ensisijainen huomioväri. Käytetään ensisijaisesti aktiivisissa painikkeissa – esim. lomakkeiden lähetyksissä.</p><h3>Purppura (#BB448E)</h3><p>Toissijainen huomioväri. Käytetään vaihtoehtoisia käyttötapauksia käynnistävissä painikkeissa – esim. hankkeen lisäasetuksissa.</p><h4>Kuntalaisaloitepalvelu</h4><h3>Vaaleanvihreä (#ADAD2D)</h3><p>Ensisijainen huomioväri. Käytetään ensisijaisesti aktiivisissa painikkeissa – esim. lomakkeiden lähetyksissä.</p><h3>Oranssi (#E2A31C)</h3><p>Toissijainen huomioväri. Käytetään vaihtoehtoisia käyttötapauksia käynnistävissä painikkeissa – esim. hankkeen lisäasetuksissa.</p>"
	},
	{
		"el": "#atoms-buttons",
		"title" : "Painikkeet – Buttons",
		"comment": "Painikkeet ovat kulmastaan yhden pikselin verran pyöristettyjä suorakulmioita. Kaikissa painikkeissa suositellaan käyttämään selventäviä ikoneita tekstiotsikon lisäksi.</p><p>Luodaan classilla, voi olla a-, input- tai button-tageilla.</p><h4>Painikkeiden ikonit</h4><p>Painikkeissa ikoni laitetaan painikkeen tekstin edelle tekstin värisenä.</p><h4>Painikkeiden tilat</h4><p>Painikkeen käytön voi estää lisäämällä painikkeen luokkaan <span style=\"red\">disabled</span>.</p>"
	},
	{
