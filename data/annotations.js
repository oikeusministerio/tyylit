...
"comments" : [
	...
	},
	{
		"el": "#atoms-colors",
		"title" : "Värit – Colors",
		"comment": "Palvelut käyttävät samaa värisarjaa. Kullekin palvelulle on valittu oma heräteväri. Värejä suunniteltaessa on huomioitava <a href=\"http://www.w3.org/Translations/WCAG20-fi/\" target=\"_blank\">WCAG 2.0</a> kontrasti- luminanssi- ja fonttivaatimukset.</p><p>Huomiovärillä merkitään käyttäjätarinan mukaan seuraava painike jota käyttäjän odotetaan pääkäyttötapauksen mukaan painavan. Vaihtoehtoisten käyttötapausten painikkeet ovat tummanharmaat. Painikkeita joita ei pääse käyttämään, ei piiloteta vaan ne näytetään vaaleammalla harmaalla.</p>Services all use same colorspace. There is a primary attention color for each service, that also serves as the brand color in the logo. Colors have their luminance according to WCAG20 accessibility requirements.</p><h3>Yhteiset Värit – Common Colors</h3><h4>Valkoinen (#FFFFF)</h4><p>Tausta huomioalueille.</p><h4>Vaaleanharmaa (#F0F0F0)</h4><p>Toissijainen taustaväri vähemmälle huomiolle tarkoitetulle alueille.</p><h4>Tummanharmaa (#444444)</h4><p>Tummanharmaa eli murrettu musta.</p><h4>Sininen (#0089F2)</h4><p>Sininen linkkiväri kautta palveluiden, joka tarjoaa paremman kontrastin kuin korostusväri eikä ole sidottu yhteen palveluun.</p><h4>Punainen (#FF0000)</h4><p>Punaista käytetään virheilmoituksissa ja muissa kriittisissä käyttäjäpalautteissa, jonka tarkoitus on saada käyttäjä pysähtyä keskeyttämään tekemänsä.</p><h4>Vihreä (#2FC090)</h4><p>Palvelun sisäisissä ilmoituksissa ja infolohkoissa on ohjealueella käytössä vihreä (tai punainen) väri. Vihreää käytetään viestimään onnistuneesti päättyneestä käyttötapauksesta tai informaatiosta, jonka tarkoitus on palkita ja kannustaa käyttäjää jatkamaan käyttöä.</p><h4>Harmaa (#E3E3E3)</h4><p>Pois käytöstä olevan tekstin, ikonin tai painikkeen väri.</p><h3>Palvelukohtaiset ohjeet – Service-specific instructions</h3><h3>Otakantaa</h3><h4>Turkoosi (#17CEE4)</h4><p>Ensisijainen huomioväri. Käytetään ensisijaisesti aktiivisissa painikkeissa – esim. lomakkeiden lähetyksissä.</p><h4>Keltainen (#D4DC3F)</h4><p>Toissijainen huomioväri. Käytetään vaihtoehtoisia käyttötapauksia käynnistävissä painikkeissa – esim. hankkeen lisäasetuksissa.</p><h3>Lausuntopalvelu (#F16521)</h3><h4>Oranssi (#F16521)</h3><p>Lausuntopalvelun ensisijainen huomioväri ja palvelun logon väri.</p><h4>Turkoosi (#12C4AE)</h4><p>Lausuntopalvelun toisisijainen huomioväri. Ei käytössä käyttöönottovaiheessa. Voi poimia sopivan Otakantaa osallistumistapojen väreistä.</p><h3>Kansalaisaloite</h3><h4>Vihreä (#077480)</h4><p>Ensisijainen huomioväri. Käytetään ensisijaisesti aktiivisissa painikkeissa – esim. lomakkeiden lähetyksissä.</p><h4>Purppura (#BB448E)</h4><p>Toissijainen huomioväri. Käytetään vaihtoehtoisia käyttötapauksia käynnistävissä painikkeissa – esim. hankkeen lisäasetuksissa.</p><h3>Kuntalaisaloitepalvelu</h3><h4>Vaaleanvihreä (#ADAD2D)</h4><p>Ensisijainen huomioväri. Käytetään ensisijaisesti aktiivisissa painikkeissa – esim. lomakkeiden lähetyksissä.</p><h4>Oranssi (#E2A31C)</h4><p>Toissijainen huomioväri. Käytetään vaihtoehtoisia käyttötapauksia käynnistävissä painikkeissa – esim. hankkeen lisäasetuksissa.</p>"
	},
	{
		"el": "#atoms-buttons",
